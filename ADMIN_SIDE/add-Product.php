...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $product_category = $_POST['product-category']; // Lấy danh mục từ form
    ...
    if ($stmt = mysqli_prepare($conn, $insert_product_query)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            if ($category_stmt = mysqli_prepare($conn, $insert_category_query)) {
                mysqli_stmt_bind_param($category_stmt, "ss", $product_id, $product_category);
      ...
      <section class="products container section--lg">
        ...
        <div id="productForm">
          ...
          <form id="add-product" method="POST">
            ...
            <input type="text" id="product-function" name="product-function" />
